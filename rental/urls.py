...
urlpatterns = [
    ...
    path('entleiher/', views.borrower_list, name='borrower_list'),
    path('entleiher/<int:pk>/bearbeiten/', views.borrower_update, name='borrower_update'),
    path('vorgaenge/neu/verfuegbarkeit/', views.product_availability, name='product_availability'),
