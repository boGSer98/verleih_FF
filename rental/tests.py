...
class DashboardViewTests(TestCase):
    ...
    def test_case_create_page_uses_minute_time_inputs_and_creates_reserved_case(self):
        ...
        self.assertIn('data-step="period"', content)
        self.assertIn('data-step="items"', content)
        self.assertIn('data-step="notes"', content)
        self.assertIn('data-step="save"', content)
        self.assertIn('card form-step is-hidden" data-step="period"', content)
        self.assertIn('card form-step is-hidden" data-step="items"', content)
        self.assertIn('card form-step is-hidden" data-step="notes"', content)
        self.assertIn('button-row form-step is-hidden" data-step="save"', content)
        self.assertIn('function revealStep(stepName)', content)
        self.assertIn('const next = revealStep(button.dataset.nextStep);', content)
