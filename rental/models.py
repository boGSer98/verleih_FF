...
class Protocol(TimeStampedModel):
    ...
    borrower_signature_name = models.CharField('Name Entleiher-Unterschrift', max_length=180, blank=True)
    borrower_signature = models.ImageField('Unterschrift Entleiher', upload_to='signatures/', blank=True, null=True)
    club_signature_name = models.CharField('Name Verein-/Helfer-Unterschrift', max_length=180, blank=True)
